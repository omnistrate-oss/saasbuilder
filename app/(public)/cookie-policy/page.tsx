  ...
  return (
    <>
      <SectionDescription>
        ...
        similar technologies to recognize you when you visit our websites. This
        document outlines what cookies are, how we use them, and your rights to
        control them.
      </SectionDescription>
      <SectionHeading>What Are Cookies?</SectionHeading>
      <SectionDescription>
        Cookies are small text files that websites store on your device to
        uniquely identify your browser or store information or settings. They
        help improve navigation, remember preferences, enable functionality, and
        analyze website performance.
        <br />
        <br />
        Cookies set by the website owner (in this case, {orgName}) are called
        &quot;first-party cookies&quot;. Cookies set by third parties are called
        &quot;third-party cookies&quot;. These enable third-party features or
        functionalities, such as advertising, analytics, or embedded content, on
        the website.
      </SectionDescription>
      ...
      <SectionDescription>
        ...
        you visit our websites, you may see a cookie notice that explains how we
        use cookies and provides an option to manage your preferences. You can:
      </SectionDescription>
      <List>
        <ListItem>
          <ListItemHeading>Cookie Settings</ListItemHeading>
          Access and update your cookie preferences at any time by clicking on
        ...
        <ListItem>
          ...
          You can configure your browser to block cookies or alert you when
          cookies are being set. Note that blocking some cookies may impact
          website functionality.
        </ListItem>
        <ListItem>
          <ListItemHeading>Google Analytics Opt-Out</ListItemHeading>
          To opt out of Google Analytics, you can install the Google Analytics
          Opt-Out Browser Add-on: Google Opt-Out.
        </ListItem>
      </List>
      <SectionHeading>Updates to This Policy</SectionHeading>
      <SectionDescription>
        We may update this Cookie Policy from time to time to reflect changes in
        technology or applicable laws. Please review this page periodically for
