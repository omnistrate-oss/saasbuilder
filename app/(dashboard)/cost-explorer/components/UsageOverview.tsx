...
const UsageOverview: FC<UsageOverviewProps> = (props) => {
  ...
  const serviceOptions = [{ serviceName: "All SaaS Products", serviceId: "" }, ...rootSubscriptionServices];
        ...
        <div className="flex flex-row items-center justify-between gap-4">
          <div>
            ...
            <Text size="xsmall" weight="medium" color="#414651">
              Memory, storage, and CPU usage by SaaS Product or subscription plan.{" "}
            </Text>
          </div>
