...
const Sidebar = () => {
  ...
  return (
    <aside className="absolute left-0 top-0 bottom-0 overflow-auto flex flex-col justify-between gap-6 px-4 py-5 border-r border-[#E9EAEB] shadow-[0_1px_2px_0_#0A0D120D] bg-white w-80">
      <div>
        {topItems.map((item) =>
          item.subItems ? (
            <ExpandibleNavItem
